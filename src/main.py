...
from BabiReader import read_babi, get_max_sizes
from DataUtils import load_glove, WordTable
...
flags.DEFINE_integer('max_sent_size', 80, 'max_sent_size')
flags.DEFINE_integer('max_ques_size', 20, 'max_ques_size')
flags.DEFINE_integer('max_fact_count', 10, 'max_fact_count')
